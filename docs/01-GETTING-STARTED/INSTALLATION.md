...
**Note:** This document contains the installation instructions for the **legacy C++/Qt version** of MapMap. For instructions on how to build the new Rust version, please refer to [BUILD.md](./BUILD.md).
